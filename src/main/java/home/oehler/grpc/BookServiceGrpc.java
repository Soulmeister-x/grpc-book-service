...
public final class BookServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<home.oehler.grpc.Bookshop.Empty,
      home.oehler.grpc.Bookshop.BookResponse> getGetAllBooksMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAllBooks",
      requestType = home.oehler.grpc.Bookshop.Empty.class,
      responseType = home.oehler.grpc.Bookshop.BookResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<home.oehler.grpc.Bookshop.Empty,
      home.oehler.grpc.Bookshop.BookResponse> getGetAllBooksMethod() {
    io.grpc.MethodDescriptor<home.oehler.grpc.Bookshop.Empty, home.oehler.grpc.Bookshop.BookResponse> getGetAllBooksMethod;
      ...
      synchronized (BookServiceGrpc.class) {
        if ((getGetAllBooksMethod = BookServiceGrpc.getGetAllBooksMethod) == null) {
          BookServiceGrpc.getGetAllBooksMethod = getGetAllBooksMethod =
              io.grpc.MethodDescriptor.<home.oehler.grpc.Bookshop.Empty, home.oehler.grpc.Bookshop.BookResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  home.oehler.grpc.Bookshop.BookResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<home.oehler.grpc.Bookshop.IdRequest,
      home.oehler.grpc.Bookshop.BookResponse> getGetBookMethod;
  ...
  public static io.grpc.MethodDescriptor<home.oehler.grpc.Bookshop.IdRequest,
      home.oehler.grpc.Bookshop.BookResponse> getGetBookMethod() {
    io.grpc.MethodDescriptor<home.oehler.grpc.Bookshop.IdRequest, home.oehler.grpc.Bookshop.BookResponse> getGetBookMethod;
    if ((getGetBookMethod = BookServiceGrpc.getGetBookMethod) == null) {
      synchronized (BookServiceGrpc.class) {
        if ((getGetBookMethod = BookServiceGrpc.getGetBookMethod) == null) {
          BookServiceGrpc.getGetBookMethod = getGetBookMethod =
              io.grpc.MethodDescriptor.<home.oehler.grpc.Bookshop.IdRequest, home.oehler.grpc.Bookshop.BookResponse>newBuilder()
  ...
  public static abstract class BookServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAllBooks(home.oehler.grpc.Bookshop.Empty request,
        io.grpc.stub.StreamObserver<home.oehler.grpc.Bookshop.BookResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetAllBooksMethod(), responseObserver);
    }

    /**
     */
    public void getBook(home.oehler.grpc.Bookshop.IdRequest request,
        io.grpc.stub.StreamObserver<home.oehler.grpc.Bookshop.BookResponse> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                ...
                home.oehler.grpc.Bookshop.BookResponse>(
  ...
  public static final class BookServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BookServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<home.oehler.grpc.Bookshop.BookResponse> getAllBooks(
    ...
    /**
     */
    public home.oehler.grpc.Bookshop.BookResponse getBook(home.oehler.grpc.Bookshop.IdRequest request) {
  ...
  public static final class BookServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BookServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<home.oehler.grpc.Bookshop.BookResponse> getBook(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ALL_BOOKS:
          serviceImpl.getAllBooks((home.oehler.grpc.Bookshop.Empty) request,
              (io.grpc.stub.StreamObserver<home.oehler.grpc.Bookshop.BookResponse>) responseObserver);
          break;
        case METHODID_GET_BOOK:
          serviceImpl.getBook((home.oehler.grpc.Bookshop.IdRequest) request,
              (io.grpc.stub.StreamObserver<home.oehler.grpc.Bookshop.BookResponse>) responseObserver);
          break;
        default:
